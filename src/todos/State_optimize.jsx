...
const RemainingItems = memo(function RemainingItems({ numberOfRemaining }) {
	return (
...
const Filters = memo(function Filters({ value, onChange }) {
	return (
...
const TodoList = memo(function TodoList({ value, onToggleDone }) {
	return (
...
const Footer = memo(function Footer({ numberOfRemaining, onClear }) {
	return (
...
const NewTodo = memo(function NewTodo({ value, onChange, onSubmit }) {
	return (
...
const Error = memo(function Error({ message }) {
	if (!message) {
		return null;
	}
...
export function State() {
	...
	const numberOfRemaining = useMemo(
		() =>
			todos.reduce((memo, item) => {
